const booksWrapper = document.querySelector("#books-wrapper"); //costante creata per il contenitore dove verranno mostrati libri
const shoppingCart = document.querySelector("#shopping-cart"); //costante per il contenitore che mostra l'elemento carrello

let outerBooks = [];  //elenco completo libri API, inizialmente vuoto
let shoppingCartList = JSON.parse(localStorage.getItem("shoppingCart")) || [];  //carica nel localeStorage gli elementi già presenti nel carrello o inizia da lista vuota
